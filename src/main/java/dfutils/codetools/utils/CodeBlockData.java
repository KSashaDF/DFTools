...
public class CodeBlockData {
	...
	public static NBTTagCompound codeData;
	
	public CodeBlockData() {
		
		try {
			//Reads codeData.json and converts it into an NBT tag.
			codeData = JsonToNBT.getTagFromJson(IOUtils.toString(this.getClass().getResourceAsStream("/assets/dfutils/codeData.json"), Charsets.UTF_8));
