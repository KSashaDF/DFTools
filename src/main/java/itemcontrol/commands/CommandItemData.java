...
public class CommandItemData extends CommandBase implements IClientCommand {
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] commandArgs) {
		...
		String itemName = itemStack.getTagCompound().toString().replaceAll("§", "&");
		
		//Creates the click and hover events for the message.
		Style messageStyle = new Style();
		messageStyle.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/internal-set_clipboard true " + itemName));
		...
		TextComponentString messageComponent = new TextComponentString("§b" + itemName);
